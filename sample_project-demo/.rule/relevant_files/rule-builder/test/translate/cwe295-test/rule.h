...
CLASS(rule)
    START_RULE(rule)
        ...
        NEW_START_STATE
        NEW_FINAL_STATE
       ADD_TRANSITION("start","_ZN3org6apache7commons4mail11SimpleEmailC1Ev",THIS_POINTER,1,"init","")
       ADD_TRANSITION("init","_ZN3org6apache7commons4mail5Email15setSSLOnConnectEJPS3_b",THIS_POINTER,GET_VALUE(GET_ARG(1)),"ssl_connect","")
       ADD_TRANSITION("ssl_connect","_ZN3org6apache7commons4mail5Email25setSSLCheckServerIdentityEJPS3_b",THIS_POINTER,GET_VALUE(GET_ARG(1)),"verified","")
       ADD_TRANSITION("verified","_ZN3org6apache7commons4mail5Email4sendEJPN4java4lang6StringEv",THIS_POINTER,1,"end","")
       ADD_TRANSITION("init","_ZN3org6apache7commons4mail5Email4sendEJPN4java4lang6StringEv",THIS_POINTER,1,"end","CWE295")
       ADD_TRANSITION("ssl_connect","_ZN3org6apache7commons4mail5Email4sendEJPN4java4lang6StringEv",THIS_POINTER,1,"end","CWE295")
        BUILD_END("rule")
    END_RULE
END_CLASS
